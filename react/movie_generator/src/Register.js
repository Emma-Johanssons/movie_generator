...
function Register() {
  ...
  return (
    <div className="flex w-screen min-h-screen justify-center gap-10 items-center flex-col bg-[#4E2E54]">
      <h1 className="text-7xl text-[#F8F4E9] font-bold">Register</h1>
      <form
      ...
      >
        ...
        <div className="mb-5">
          ...
          <input
            className=" bg-[#4E2E54] mb-3 border-2 border-[#47294c] text-[#F8F4E9] text-sm rounded-lg focus:ring-violet-200 focus:border-violet-200 block p-2.5 w-80"
            type="password"
            value={password}
